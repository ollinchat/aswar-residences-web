...
export const copy = {
  en: {
    ...
    districtHlDowntownKicker: "Skyline",
    districtHlMarinaTitle: "Dubai Marina",
    districtHlMarinaKicker: "Waterfront",
    districtHlLeisureTitle: "Leisure District",
    districtHlLeisureKicker: "Destinations",
    districtHlNightTitle: "City Evenings",
    districtHlNightKicker: "After dark",
    districtHlNatureTitle: "Desert & nature",
    districtHlNatureKicker: "Within reach",
  ...
  ar: {
    ...
    districtHlDowntownTitle: "وسط دبي",
    districtHlDowntownKicker: "أفق حضري",
    districtHlMarinaTitle: "دبي مارينا",
    districtHlMarinaKicker: "واجهة مائية",
    districtHlLeisureTitle: "وجهات ترفيهية",
    districtHlLeisureKicker: "على بُعد خطوات",
    districtHlNightTitle: "أمسيات المدينة",
    districtHlNightKicker: "بعد الغروب",
    districtHlNatureTitle: "الصحراء والطبيعة",
    districtHlNatureKicker: "في متناول الجميع",
