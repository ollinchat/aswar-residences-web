  ...
  return (
    <>
      ...
      <main className="bg-parchment px-6 pb-32 pt-32 text-charcoal md:px-12 md:pt-40">
        ...
        <p className="mt-4 font-mono text-[11px] uppercase tracking-widest text-charcoal/45">
          Engineering · Contracting · Parent organisation
        </p>
        <div className="mt-12 max-w-md rounded-sm border border-charcoal/10 bg-parchment p-8">
          <Image
        ...
        <div className="mt-12 max-w-2xl space-y-6 font-serif text-lg leading-relaxed text-charcoal/85">
          <p>
        ...
        <a
          ...
          className="mt-10 inline-flex font-mono text-[10px] uppercase tracking-[0.25em] text-champagne hover:text-charcoal"
        >
          sami-najami.com ↗
        </a>
        <div className="mt-14">
