    ...
    >
      {mapReady ? (
        <MapContainer
          ...
          center={CENTER}
          zoom={13}
          className="dark-map-container z-0 h-full w-full min-h-[360px] overflow-hidden"
        ...
        <div
          className="flex h-full min-h-[360px] w-full items-center justify-center bg-[#1a1a1a]"
          aria-busy="true"
        />
      )}
    </div>
